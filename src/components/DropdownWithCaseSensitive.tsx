...
export default function DropdownWithCaseSensitive({ label, options: initialOptions, onSave, onCancel }: DropdownProps) {
  ...
  const hasExactMatch = options.includes(searchText);
      ...
      <div className="relative">
        ...
        {isOpen && (
          <div className="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-md shadow-lg max-h-80 overflow-auto">
            ...
            {searchText && !hasExactMatch && selectedOption !== searchText && isTyping && (
              <div
                className="px-4 py-2 hover:bg-gray-100 cursor-pointer text-base"
